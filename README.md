...
/system scheduler add name="update-vn-ipv4-list" start-time=03:00:00 interval=1d on-event="/tool fetch url=\"https://raw.githubusercontent.com/lehoangnb/mikrotik-vn-ip/main/vn_ipv4.rsc\" mode=https dst-path=\"vn_ipv4.rsc\"\r\n/import file-name=\"vn_ipv4.rsc\"" comment="Auto update VN IPv4 list daily from GitHub Actions" policy=ftp,reboot,read,write,policy,test,password,sniff,sensitive,romon

# 2. Chạy lệnh thủ công 1 lần đầu tiên ngay bây giờ để dọn list cũ và nạp data siêu sạch từ RIPE về
/tool fetch url="https://raw.githubusercontent.com/lehoangnb/mikrotik-vn-ip/main/vn_ipv4.rsc" mode=https dst-path="vn_ipv4.rsc"
